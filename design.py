...
def browse_folder():
    # Allow users to browse and select an image folder
...
ttk.Label(main_frame, text="FACE REGENERATION", style='info.TLabel', foreground='green', font=("Aerial", 35)).pack(pady=10)

details_frame = ttk.Frame(main_frame)

image_frame = ttk.Frame(main_frame)
image_frame.pack(pady=25)
ttk.Label(image_frame, text="Upload Image Folder:").pack(padx=25)
upload_button = ttk.Button(image_frame, text="Upload Folder", command=browse_folder)
upload_button.pack(padx=25)

folder_label = ttk.Label(main_frame, text="")
folder_label.pack(pady=10)

ttk.Button(main_frame, text="Regenerate", command=result_form).pack(pady=10)
